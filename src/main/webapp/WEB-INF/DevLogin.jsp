...
<div class="row p-4 mt-5 align-items-center rounded-3 border shadow-lg">
    ...
    <h2 class="lead">Let's connect you to a job!</h2>
    <form:form method="POST" action="/devs/login" modelAttribute="newLogin">
        <div class="mt-2">
        ...
        <div class="mt-2">
	        ...
	        <a class="btn btn-secondary mb-2" href="/orgs/login">Login as Organization</a>
	    </div>
    </form:form>
</div>
</div>
